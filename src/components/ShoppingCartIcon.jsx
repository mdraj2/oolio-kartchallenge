const ShoppingCartIcon = (props) => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 128 128"
    >
      <g id="_x31_5_1_" className="hidden">
        <g id="icon" className="inline">
          <path
            className={color}
            d="M122.6,46.3H70.8V19.1c0-3-2.4-5.4-5.4-5.4c-3,0-5.4,2.4-5.4,5.4v27.2H5.4c-3,0-5.4,2.4-5.4,5.4
      ...
      <g id="_x31_4_1_" className="hidden">
        <g id="icon_1_" className="inline">
          <path
            className={color}
            d="M95.3,49.6c-2.2,0-3.9,1.8-3.9,3.9c0,2.2,1.8,3.9,3.9,3.9s3.9-1.8,3.9-3.9C99.3,51.4,97.5,49.6,95.3,49.6z
      ...
      <g id="_x31_3_1_" className="hidden">
        <g id="icon_2_" className="inline">
          <path
            className={color}
            d="M125.1,43.6h-20.4V17.5H84.4v-2.9H46.5v2.9H26.2v26.2H2.9c-1.6,0-2.9,1.3-2.9,2.9v8.7c0,1.6,1.3,2.9,2.9,2.9
      ...
      <g id="_x31_2_1_" className="hidden">
        <g id="icon_3_" className="inline">
          <path
            className={color}
            d="M72.7,106.2V68.4h-5.8v37.8H72.7z M61.1,68.4h-5.8v37.8h5.8V68.4z M84.4,68.4h-5.8v37.8h5.8V68.4z M58.2,62.5
      ...
      <g id="_x31_1_1_" className="hidden">
        <g id="icon_4_" className="inline">
          <path
            className={color}
            d="M20,120.5c0,0,3.5,3.4,6.2,3.4h75.5c0,0,5.2,0.2,6.1-3.6l16.8-62H3.3L20,120.5z M95.2,110.8H32.8
      ...
      <g id="_x31_0_1_" className="hidden">
        <g id="icon_5_" className="inline">
          <path
            className={color}
            d="M93.8,55.7l-4.7-10.6l-4.5,10.4L89.3,66L93.8,55.7z M100,41.6l-4.7-10.6l-4.6,10.5L95.4,52L100,41.6z
      ...
      <g id="_x39__1_" className="hidden">
        <g id="icon_6_" className="inline">
          <path
            className={color}
            d="M31.2,42.1V14V7.8H0V14h25v28.1v6.2v50c0,0,44.4,0,46.8,0c31,0,41.5-12.4,50-31.2c1.1-2.5,2.1-5.9,3-9.4h0.1
        ...
        <g id="delete" className="inline">
          <path
            className={color}
            d="M70.2,51.5c-9.5,0-17.2,7.7-17.2,17.2s7.7,17.2,17.2,17.2s17.2-7.7,17.2-17.2S79.7,51.5,70.2,51.5z
      ...
      <g id="_x38__1_" className="hidden">
        <g id="icon_7_" className="inline">
          <path
            className={color}
            d="M27.4,13.7V7.6H0v6.1h21.3V99h6.1h70.1V93H27.4V13.7z M33.5,68.6h82.3v-6.1H33.5V68.6z M33.5,83.8h73.1v-6.1
      ...
      <g id="_x37__1_" className="hidden">
        <g id="icon_8_" className="inline">
          <path
            className={color}
            d="M107.6,74.2L128,27.6H40.7l11.6,46.5H107.6z M90.6,57.7l8.7-16.8c0.8-1.5,2.6-2.1,4-1.2
      ...
      <g id="_x36__1_" className="hidden">
        <g id="icon_9_" className="inline">
          <path
            className={color}
            d="M19.3,14.4c-0.3-1.3-1.4-2.2-2.7-2.2H2.7C1.2,12.3,0,13.5,0,15c0,1.5,1.2,2.7,2.7,2.7h11.7l25.8,74.1
      ...
      <g id="_x35__1_" className="hidden">
        <g id="icon_10_" className="inline">
          <path
            className={color}
            d="M124.5,39.8h-3.5h-83v6.9h83v6.9h-83v6.9h83v6.9h-83v6.9h83v6.9H31.1V8.6V1.7H0v6.9h24.2v79.6h6.9H128v-3.5
      ...
      <g id="_x34__1_">
        <g id="icon_11_">
          <path
            className={color}
            d="M45.3,81.2h78V43.7L35.9,25.4l-3.1-12.9L20.2,8.3c0-0.2,0.1-0.3,0.1-0.5c0-4.3-3.5-7.8-7.8-7.8
      ...
      <g id="_x33__1_" className="hidden">
        <g id="icon_12_" className="inline">
          <path
            className={color}
      ...
      <g id="_x32__1_" className="hidden">
        <g id="icon_13_" className="inline">
          <path
            className={color}
            d="M61.1,40.7h14.5V32H61.1V40.7z M78.5,55.3h14.5V43.6H78.5V55.3z M43.6,40.7h14.5V32H43.6V40.7z M78.5,40.7
      ...
      <g id="_x31__1_" className="hidden">
        <g id="icon_14_" className="inline">
          <path
            className={color}
            d="M92.1,96c-5.2,0-9.3,4.2-9.3,9.3c0,5.2,4.2,9.3,9.3,9.3s9.3-4.2,9.3-9.3C101.4,100.2,97.3,96,92.1,96z
